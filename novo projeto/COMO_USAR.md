...
- **ATUALIZAR_PAINEL.bat**: Executavel de 1 clique para consolidar e atualizar os paineis.
- **ROBO_VARREDURA_PWR.bat**: Executavel para rodar a varredura e download automatico do PWR.
- **index.html**: Portal inicial com selecao entre Franquias e Lojas Proprias.
- **ranquias/**: Painel completo de Franquias (HTML, CSS, JS e dados).
...
- **tualizar_painel.py**: Motor Python que executa o processamento matematico oficial.
- **arredura_backfill_pwr.py**: Motor do robo de navegacao e download do PWR.
